...
//	$.Msg( msg.hero_id )
	...
	else if ( msg.hero_id == "npc_dota_hero" )
	{
		$( "#PickupMessage_Hero_Text" ).SetDialogVariable( "hero_id", $.Localize( "#npc_dota_hero_shinobu_notification" ) );
	}
	else
	{
	...
	var item_image_name = "file://{images}/items/" + msg.dropped_item + ".png"
...
//	$.Msg( "leader_has_been_killed: ", msg );
	...
	if ( msg.hero_id == "npc_dota_hero" )
	{
		$( "#KillMessage_Hero" ).SetDialogVariable( "hero_id", $.Localize( "#npc_dota_hero_shinobu_notification" ) );
	}
	else
	{
